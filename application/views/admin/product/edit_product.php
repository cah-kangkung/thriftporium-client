                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control <?php echo (form_error('weight')) ? 'is-invalid' : ''; ?>" name="weight" id="weight" placeholder="Enter weight (ex. 500)" value="<?php echo $product['product_weight']; ?>">
